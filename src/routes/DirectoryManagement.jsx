            ...
            <div className="topic">
                ...
                <table className="table">
                    <tbody>
                        ...
                        <tr>
                            <td>cd dirName</td>
                            <td data-label="cd dirName">This will navigate you to the specified directory as long as it is one branch lower in the directory tree (listed within your current directory)</td>
                        </tr>
                        <tr>
                            <td>cd path/dirName</td>
                            <td data-label="cd path/dirName">This type of traversing uses the relative path of the directory. The relative path starts from the current directory continues down the branches of the tree (other directories) until the target.</td>
                        </tr>
                        <tr>
                            <td>cd fullPath/dirName</td>
                            <td data-label="cd fullPath/dirName">This type of traversing uses the absolute path of the directory. It starts from the root directory and includes all subsequent directories.</td>
                        </tr>
                        <tr>
                            <td>cd ..</td>
                            <td data-label="cd ..">This is like a back button. It will navigate you back to the previous (parent) directory. Combining it with / and more dots will navigate you back more directories.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
