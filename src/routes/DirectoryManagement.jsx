  ...
  return (
    <div className="module">
        ...
        <div className="module_body">
            ...
            <br/>
            <p className="module_intro"> In this lesson, you will learn about the directory structure and the different commands that can be used for it.</p>
            <br/>
            ...
            <div className="topic">
                ...
                <table className="table">
                    <tbody>
                        ...
                        <tr>
                            <td>cd</td>
                            <td data-label="cd">The command by itself will always take you back to your home directory.</td>
                        </tr>
                        <tr>
                            <td>cd dirName</td>
                            <td data-label="cd dirName">This will navigate you to the specified directory as long as it is one branch <br/>lower in the directory tree (listed within your current directory)</td>
                        </tr>
                        <tr>
                            <td>cd path/dirName</td>
                            <td data-label="cd path/dirName">This type of traversing uses the relative path of the directory. The relative <br/>path starts from the current directory continues down the branches of the tree (other directories) until the target.</td>
                        </tr>
                        <tr>
                            <td>cd fullPath/dirName</td>
                            <td data-label="cd fullPath/dirName">This type of traversing uses the absolute path of the directory. It starts from <br/>the root directory and includes all subsequent directories.</td>
                        </tr>
                        <tr>
                            <td>cd ..</td>
                            <td data-label="cd ..">This is like a back button. It will navigate you back to the previous (parent) <br/>directory. Combining it with / and more dots will navigate you back more directories.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div className="topic">
                ...
                <p className="topic_ex"><span>mkdir</span> newDirName</p>
            </div>
            <div className="break">============</div>
            <div className="topic">
                ...
                <p className="topic_ex"><span>rmdir</span> dirName</p>
            </div>
            <div className="break">============</div>
            <div className="topic">
                ...
                <table className='table'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="mv dirName /path/dest">Moves the directory to the specified destination</td>
                        </tr>
                        <tr> 
                            <td>mv dirName newDirName</td>
                            <td data-label="mv dirName newDirName">Renames the directory to the specified new name</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div className="practice">
            ...
            <Link to="/DMPractice" className="practice_link">CLICK HERE FOR PRACTICE!</Link>
        </div>
        <div className="break">============</div>
