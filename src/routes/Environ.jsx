    ...
    <div className="env">
        ...
        <div className='env_body'>
            ...
            <div className="env_man">
                <h3 className="man_title">What is man?</h3>
                <p>
            ...
            <div className="env_uname">
                <h3 className="uname_title">What is uname?</h3>
                <p>
            ...
            <div className="env_whoami">
                <h3 className="whoami_title">What is whoami?</h3>
                <p>
            ...
            <div className="env_who">
                <h3 className="who_title">What is who?</h3>
                <p>
            ...
            <div className="env_su">
                <h3 className="su_title">What is su?</h3>
                <p>
                ...
                <p className="whereis_ex"> su userName</p>
            </div>
            <div className="break">============</div>
            <div className="env_passwd">
                <h3 className="passwd_title">What is passwd?</h3>
                <p>
            ...
            <div className="env_env">
                <h3 className="e_title">What is env?</h3>
                <p>
            ...
            <div className="env_whereis">
                <h3 className="whereis_title">What is whereis?</h3>
                <p>
            ...
            <div className="env_whatis">
                <h3 className="whatis_title">What is whatis?</h3>
                <p>
            ...
            <div className="env_ps">
                <h3 className="ps_title">What is ps?</h3>
                <p>
            ...
            <div className="env_kill">
                <h3 className="kill_title">What is kill?</h3>
                <p>
            ...
            <div className="env_amp">
                <h3 className="amp_title">What is &?</h3>
                <p>
            ...
            <div className="env_bg">
                <h3 className="bg_title">What is bg?</h3>
            ...
            <div className="env_fg">
                <h3 className="fg_title">What is fg?</h3>
            ...
            <div className="env_top">
                <h3 className="top_title">What is top?</h3>
                <p>
            ...
            <div className="env_ssh">
                <h3 className="ssh_title">What is ssh?</h3>
                <p>
            ...
            <div className="env_scp">
                <h3 className="scp_title">What is scp?</h3>
                <p>
            ...
            <div className="env_ifconfig">
                <h3 className="ifconfig_title">What is ifconfig?</h3>
                <p>
            ...
            <div className="env_ping">
                <h3 className="ping_title">What is ping?</h3>
                <p>
            ...
            <div className="break">============</div>
            <div className="env_g">
                <h3 className="g_title">What is g++?</h3>
                <p>
