...
const FMPractice = () => {
  ...
  const pattern6 = new RegExp(/^(echo)\s+('aloha')\s+(>)\s+()filename.txt\s*$/i)
  const pattern7 = new RegExp(/^(cat)\s+(filename.txt)\s+$/i)
  const pattern8 = new RegExp(/^(cd)\s+(..)\s+(;)\s+(touch)\s+(test.txt)\s*$/i)
  const pattern9 = new RegExp(/^(cp)\s+(test.txt)\s+(virtualDesktop)\s+(;)\s+(ls)\s+(;)\s+(cd)\s+(virtualDesktop)\s+(;)\s+(echo)\s+('this line should be merged')\s+(>)\s+(test.txt)\s(;)\s+(cat)\s+('filename.txt')\s+('test.txt')\s+(>)\s+('merged_fn.txt')\s*$/i)
  ...
  const pattern17 = new RegExp(/^(rm)\s+(test.txt)\s+(merged_fn.txt)\s+(;)\s+(ls)\s*$/i)
